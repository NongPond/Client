    ...
    ">
      ...
      ">
        ...
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-2 text-2xl font-bold text-blue-600 dark:text-blue-400 cursor-pointer hover:opacity-80 transition">
        ...
        <div className="flex gap-3 sm:gap-4 items-center">
          <button
            ...
            className="
                ...
                px-6 py-2.5 rounded-xl font-medium text-[15px]
      ...
      <div className="
        ...
        px-6 lg:px-12 py-16 lg:py-28 gap-12 lg:gap-8
      ">

        {/* LEFT CONTENT */}
        <div className="w-full lg:w-7/12 space-y-8 relative z-10">
          {/* พาดหัวหลัก (Heading) แบบมี Gradient Text */}
          <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold leading-[1.25] tracking-tight">
            ...
            {/* คำอธิบาย (Subheading) */}
            <p className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 max-w-2xl font-light leading-relaxed">
          ...
          <div className="pt-2 max-w-lg">
            {/* ปรับ p-1.5 เป็น p-2 และเพิ่ม gap-2 เพื่อเว้นระยะระหว่างช่องกรอกกับปุ่ม */}
        ...
        {/* RIGHT IMAGE */}
        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end lg:translate-x-12">
          {/* Decorator Blur Blob */}
      ...
      <div className="relative bg-white dark:bg-[#0f172a] py-20 lg:py-28 border-t border-gray-100 dark:border-gray-800">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <h3 className="text-3xl sm:text-4xl font-bold text-[#091E42] dark:text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="group bg-gray-50 dark:bg-[#1e293b] p-8 rounded-3xl hover:bg-white dark:hover:bg-[#0b1324] hover:shadow-2xl hover:shadow-blue-900/5 border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-all duration-300 hover:-translate-y-1">
              <div className="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center text-3xl mb-6 shadow-sm group-hover:scale-110 transition-transform">
                👥
              </div>
              ...
              <ul className="text-gray-600 dark:text-gray-400 text-sm space-y-2.5">
                ...
                <li className="flex items-start gap-2"><span className="text-blue-500 mt-0.5">✓</span> สร้างและจัดการสิทธิ์สมาชิก Owner/Editor/Viewer</li>
            ...
            <div className="group bg-gray-50 dark:bg-[#1e293b] p-8 rounded-3xl hover:bg-white dark:hover:bg-[#0b1324] hover:shadow-2xl hover:shadow-purple-900/5 border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-all duration-300 hover:-translate-y-1">
              <div className="w-14 h-14 bg-purple-100 dark:bg-purple-900/30 rounded-2xl flex items-center justify-center text-3xl mb-6 shadow-sm group-hover:scale-110 transition-transform">
                📋
              </div>
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Smart Kanban</h4>
              <ul className="text-gray-600 dark:text-gray-400 text-sm space-y-2.5">
                <li className="flex items-start gap-2"><span className="text-purple-500 mt-0.5">✓</span> ลากและวาง (Drag & Drop) เพื่อเปลี่ยนสถานะ</li>
            ...
            <div className="group bg-gray-50 dark:bg-[#1e293b] p-8 rounded-3xl hover:bg-white dark:hover:bg-[#0b1324] hover:shadow-2xl hover:shadow-orange-900/5 border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-all duration-300 hover:-translate-y-1">
              <div className="w-14 h-14 bg-orange-100 dark:bg-orange-900/30 rounded-2xl flex items-center justify-center text-3xl mb-6 shadow-sm group-hover:scale-110 transition-transform">
                📅
              </div>
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-4">มุมมองปฏิทิน</h4>
              <ul className="text-gray-600 dark:text-gray-400 text-sm space-y-2.5">
                <li className="flex items-start gap-2"><span className="text-orange-500 mt-0.5">✓</span> ดูตารางปฏิทินรวมแบบรายวัน/สัปดาห์/เดือน</li>
                <li className="flex items-start gap-2"><span className="text-orange-500 mt-0.5">✓</span> กรองดูงานแบบแยกตามหมวดหมู่</li>
                <li className="flex items-start gap-2"><span className="text-orange-500 mt-0.5">✓</span> ดาวน์โหลดรูปภาพปฏิทินงาน</li>
              </ul>
            </div>
            ...
            <div className="group bg-gray-50 dark:bg-[#1e293b] p-8 rounded-3xl hover:bg-white dark:hover:bg-[#0b1324] hover:shadow-2xl hover:shadow-teal-900/5 border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-all duration-300 hover:-translate-y-1">
              <div className="w-14 h-14 bg-teal-100 dark:bg-teal-900/30 rounded-2xl flex items-center justify-center text-3xl mb-6 shadow-sm group-hover:scale-110 transition-transform">
                🔔
              </div>
              ...
              <ul className="text-gray-600 dark:text-gray-400 text-sm space-y-2.5">
                ...
                <li className="flex items-start gap-2"><span className="text-teal-500 mt-0.5">✓</span> เปลี่ยนธีมสว่าง/มืด (Light/Dark Mode) ได้</li>
                <li className="flex items-start gap-2"><span className="text-teal-500 mt-0.5">✓</span> ตั้งค่ารับการแจ้งเตือนอัตโนมัติ</li>
              </ul>
            </div>
          ...
          <div className="pt-4">
            <button
              ...
              className="
                ...
                px-10 py-4 rounded-2xl shadow-xl shadow-black/10
      ...
      ">
        <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-xl font-bold text-gray-800 dark:text-gray-200">
            <span className="text-2xl mr-1">🧩</span> Task Management
          </div>
        </div>
      </footer>
